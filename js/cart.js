...
async function checkDuplicateBooksBeforePay() {
  ...
  const response = await fetch(
    "https://script.google.com/macros/s/AKfycbzvVvv9CrF_FZvpNi8v5ICJoV-GGmIFuHvh1JofvITRkKV1--qPVbjtn6r6Db0Rx4FNcw/exec", 
    {
      method: "POST",
      body: JSON.stringify({
...
document.addEventListener("click", async e => {
  ...
  await fetch("https://script.google.com/macros/s/AKfycbzWVtGftE80YjxVM28r8YUs-LuAZgF2YXxE6RbFuT13QbpEsg7eHpg5WYWn6RgXEH4J/exec", {
  method: "POST",
