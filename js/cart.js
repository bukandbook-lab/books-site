...
try {
  ...
  const response = await fetch(
    "https://script.google.com/macros/s/AKfycbze2HdRCavkT_xVHVi2CF8k3Q1gwxaK2lgE3sCvWfl68M2-rGAjQ5nzelJf4kGm60fOog/exec",
    {
      method: "POST",
      headers: {
...
document.addEventListener("click", async e => {
  ...
  await fetch("https://script.google.com/macros/s/AKfycbxHO7O8QEaM52r7RP4cnSVN2Rdg4m5wfc6EAW7q47MFcpMpY8RdgHralDJ7-ctID-l6/exec", {
  method: "POST",
